...
public class DustSandBlock extends Block {
    ...
    private static final VoxelShape BREAK_SHAPED_1 = Block.createCuboidShape(0.0,0.0,0.0,16.0,14.0,16.0);
    private static final VoxelShape BREAK_SHAPED_2 = Block.createCuboidShape(0.0,0.0,0.0,16.0,12.0,16.0);
    private static final VoxelShape BREAK_SHAPED_3 = Block.createCuboidShape(0.0,0.0,0.0,16.0,10.0,16.0);
    private static final VoxelShape BREAK_SHAPED_4 = Block.createCuboidShape(0.0,0.0,0.0,16.0,9.0,16.0);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (item == ItemInit.BRUSH){
            switch (state.get(BREAK)){
                case 0-> {
                    if (world.isClient){
                        player.playSound(SoundEvents.BLOCK_SAND_BREAK, 1.0f,0.8f);
